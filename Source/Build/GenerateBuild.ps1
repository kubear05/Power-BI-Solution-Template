function Build
{
    ...
    $sqlScriptsDynamics = @("DynamicsPreDeploy.SQL", "DynamicsScribeTables.SQL", "DynamicsSmgtTables.SQL", "DynamicsSmgtViews.SQL", "DynamicsPostDeploy.SQL")
    $sqlScriptsSalesforce = @("SalesforcePreDeploy.SQL", "SalesforceScribeTables.SQL", "SalesforceSmgtTables.SQL", "SalesforceSmgtViews.SQL", "SalesforcePostDeploy.SQL")
